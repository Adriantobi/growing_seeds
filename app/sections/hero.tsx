...
export default function HeroSection() {
  return (
    <div className='flex flex-col relative text-center'>
      <span className='blur-2xl w-full absolute opacity-85'>
        <span className='max-w-[36em] h-[40em] opacity-75 bg-gradient-to-b from-accent2 to-accent [clip-path:polygon(50%_0,100%_100%,0_100%)] absolute left-0 right-0 top-0 mx-auto'/>
      </span>
      <div className='pt-44 z-10 flex flex-col items-center gap-10'>
