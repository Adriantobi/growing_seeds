...
export default function CallToActionSection() {
  return (
    <div className='flex h-[calc(100vh-68px)] flex-col pt-20 relative overflow-hidden'>
      <div className='flex flex-col gap-10 justify-center items-center z-10'>
        <span className='text-5xl max-w-[14em] text-center'>Take a hold of your church&apos;s financial future today</span>
